        ...
        <div class="container-fluid">
          ...
          <div class="card card-primary card-outline mb-4 col-md-6">
                  ...
                  <div class="card-header">
                    <div class="card-title">Silahkan Tambah Transaksi</div>
                  </div>
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form action="/tambahkantrankedb" method="POST">
                    @csrf
                    <!--begin::Body-->
                    <div class="card-body">
                      <div class="mb-3">
                        <label for="kodeproduk" class="form-label">Tanggal Transaksi</label>
                        <input name="tanggaltransaksi" type="date" class="form-control" id="tanggaltransaksi" />
                      </div>
                      <div class="mb-3">
                        <label for="kodetransaksi" class="form-label">Kode Transaksi</label>
                        <input name="kodetransaksi" type="text" class="form-control" id="namaproduk" />
                      </div>
