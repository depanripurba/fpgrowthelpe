...
class TransaksiControler extends Controller
{
    ...
    public function itemSet()
    {
        ...
        // menentukan nilai kemunculan produk


        // end kemunculan produk

        // menentukan nilai support dari produk


        //end menentukan nilai suport


        // urutkan transaksi dari tinggi kecil membentuk 2 item set
        // endd 2 item set
